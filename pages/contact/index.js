    ...
    return (
      <div className="py-11 bg-gradient-to-b from-gray-800/10 to-gray-100/100 min-h-[100vh]">
        ...
        <form className="flex justify-center items-around flex-col font-light text-2xl font-roboto px-10">
          ...
          <button className="block w-full py-3 px-6 rounded-xl bg-cyan-600 transition hover:bg-cyan-500 focus:bg-cyan-700 hover:cursor-pointer active:bg-cyan-800 text-gray-100">Submit</button>
        </form>
      </div>
    )
  }
